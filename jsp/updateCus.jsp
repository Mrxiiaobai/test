...
<%
   ...
   //创建StudentDao对象
    ...
    customer cus = cusDao.getCusByCusname(user);
...
<form action="updateServlet" method="post">
    <table align="center" border="1px solid black" class="table table-striped">
        <tr>
            <td>用户名</td>
            <td><input type="text" name="username" readonly unselectable="on"  value="<%=cus.getUsername()%>" style="pointer-events: none;"> </td>
        </tr>
        <tr>
            <td>密码</td>
        ...
        <tr>
            <td>地址</td>
            <td>
                <input type="text" name="cityPro" value="<%=cus.getCityPro()%>" >
                <input type="text" name="cityDis" value="<%=cus.getCityDis()%>" >
            </td>
        </tr>
        <tr>
            <td>姓名</td>
            <td><input type="text" name="customername"  value="<%=cus.getCustomername()%>"> </td>
        </tr>
        <tr>
            <td>电话</td>
            <td><input type="text" name="tel"  value="<%=cus.getTel()%>"> </td>
        </tr>
        <tr>
            <td colspan="2">
